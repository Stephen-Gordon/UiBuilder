          ...
          <>
            ...
            >
                ...
                {isPageVisible && (
                  <motion.div
                    ...
                    exit={{
                      ...
                      transition: {
                        duration: 0.2,
                        ease: [0.71, 0.03, 0.56, 0.95],
                      },
                    }}
                  >
                    <Typography
                      align="center"
                      sx={{ zIndex: "1501", my: 1, fontWeight: "" }}
                      color={"text.primary"}
                      variant={"subtitle1"}
                    >
                      {title}
              ...
              >
                ...
                <motion.div
                  ...
                  layoutId="text"
                  transition={{
                    layout: { duration: 0.3, ease: [0.8, 0.1, 0.2, 0.9] },
                  }}
            ...
            <Grid sx={{ width: "100%", display: "flex" }}>
              ...
              <MobileBackground
                ...
                setRenderController={setRenderController}
              ...
              <MobilePrimaryController
                ...
                setIsPrimaryVisible={setIsPrimaryVisible}
              ...
              <MobileTypographyController
                isTypographyVisible={isTypographyVisible}
                theme={theme}
                fonts={fonts}
                setFont={setFont}
                customPalette={customPalette}
