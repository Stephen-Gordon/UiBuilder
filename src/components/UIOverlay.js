...
const UIOverlay = ({isVisible, theme, palette, font,  setPalette, fonts}) => {
 ...
 */}
            ...
            <Grid
                ...
                style={{ minHeight: `calc(100vh - 130px)`, alignContent: 'center', justifyContent: 'center'  }} >
            ...
            <Grid
                container 
                column={12} 
                sx={{display: 'flex', position: 'sticky', top: '0px', backgroundColor:  alpha(theme.palette.background.default, 0.7), backdropFilter: 'blur(60px)',  borderTopLeftRadius: '24px', borderTopRightRadius: '24px', 
                borderTop: '1px solid', borderColor: 'border', alignContent: 'center', justifyContent: 'center', height: 'auto'
                }} 
                >
                
            
                    <Grid style={{ minHeight: `calc(100vh - 130px)`, alignContent: 'center', display: 'flex' }} >
                        <Grid item xs={12} lg={6} xl={6} sx={{display: 'flex', justifyContent: 'center'}}>
                            <Card elevation={0} sx={{width: '100%', height: `calc(50vh - 130px)`, mx:2, my:0, borderRadius: '24px', p: {xs:2, lg:5}}}>
                    ...
                    <Grid 
                        container column={12} sx={{ minHeight: '100vh', display: 'flex', alignContent: 'center', justifyContent: 'space-around',  backgroundColor: alpha(theme.palette.background.default, 1), pt: {xs:'130px', lg:0}}} 
                        >
